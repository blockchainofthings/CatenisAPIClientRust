...
impl CatenisClient {
    ...
    /// # }
    /// ```
    pub fn log_message(&mut self, message: Message, options: Option<LogMessageOptions>) -> Result<LogMessageResult> {
    ...
    /// # }
    /// ```
    pub fn send_message(&mut self, message: Message, target_device: DeviceId, options: Option<SendMessageOptions>) -> Result<SendMessageResult> {
    ...
    pub fn export_asset(
        ...
        Ok(Self::parse_response::<ExportAssetResponse>(res)?.data)
    }
    ...
    pub fn migrate_asset(
        ...
        Ok(Self::parse_response::<MigrateAssetResponse>(res)?.data)
    }
    ...
    pub fn asset_export_outcome(
        ...
        Ok(Self::parse_response::<AssetExportOutcomeResponse>(res)?.data)
    }
    ...
    /// # }
    /// ```
    pub fn asset_migration_outcome(
        &mut self,
        migration_id: &str,
        ...
        Ok(Self::parse_response::<AssetMigrationOutcomeResponse>(res)?.data)
    }
    ...
    /// # }
    /// ```
    pub fn list_exported_assets(&mut self, options: Option<ListExportedAssetsOptions>) -> Result<ListExportedAssetsResult> {
        // Prepare query parameters
        let mut params_vec = Vec::new();
        let asset_id;
        ...
        Ok(Self::parse_response::<ListExportedAssetsResponse>(res)?.data)
    }
    ...
    /// # }
    /// ```
    pub fn list_asset_migrations(&mut self, options: Option<ListAssetMigrationsOptions>) -> Result<ListAssetMigrationsResult> {
        // Prepare query parameters
        let mut params_vec = Vec::new();
        let asset_id;
        let foreign_blockchain;
        ...
        Ok(Self::parse_response::<ListAssetMigrationsResponse>(res)?.data)
    }
    ...
    fn compress_body(body: String) -> Result<Vec<u8>> {
        let mut enc = ZlibEncoder::new(body.as_bytes(), Compression::default());
...
mod tests {
    ...
    #[test]
    fn it_fail_call_api_no_credentials() {
        // Instantiate Catenis API client
        let mut ctn_client = CatenisClient::new_with_options(
            None,
            &[
                ClientOptions::Host("localhost:4001"),
                ClientOptions::Secure(false),
            ],
        ).unwrap();
        ...
        assert!(result.is_err(), "API call succeeded when it should have failed");
        assert_eq!(result.err().unwrap().to_string(), "Catenis client error: Missing virtual device credentials");
    }

    #[test]
    fn it_log_message_whole() {
  ...
  "data": {
    ...
    #[test]
    fn it_send_message_whole_async() {
        // Simulate successful 'Send Message' API method response
  ...
  "data": {
    ...
    #[test]
    fn it_retrieve_message_container() {
  ...
  "data": {
    ...
    #[test]
    fn it_retrieve_ipfs_message_container() {
        // Simulate successful 'Retrieve Message Container' API method response
  ...
  "data": {
    ...
    #[test]
    fn it_retrieve_off_chain_message_container() {
        // Simulate successful 'Retrieve Message Container' API method response
  ...
  "data": {
    ...
    #[test]
    fn it_retrieve_message_origin_with_proof() {
        // Simulate successful 'Retrieve Message Origin' API method response
  ...
  "data": {
    ...
    #[test]
    fn it_retrieve_off_chain_message_origin() {
        // Simulate successful 'Retrieve Message Origin' API method response
  ...
  "data": {
    ...
    #[test]
    fn it_retrieve_off_chain_message_origin_with_proof() {
        // Simulate successful 'Retrieve Message Origin' API method response
  ...
  "data": {
    ...
    #[test]
    fn it_retrieve_log_message_progress() {
  ...
  "data": {
    ...
    #[test]
    fn it_retrieve_read_message_progress() {
        // Simulate successful 'Retrieve Message Progress' API method response
  ...
  "data": {
    ...
    #[test]
    fn it_retrieve_asset_issuance_history() {
  ...
  "data": {
    ...
    #[test]
    fn it_export_asset_estimate_only() {
  ...
  "data": {
    ...
    #[test]
    fn it_migrate_asset_estimate_only() {
  ...
  "data": {
    ...
    "receive-asset-from": "Receive an amount of an asset from a device"
        ...
        let result = ctn_client.list_permission_events().unwrap();
    ...
    #[test]
    fn it_retrieve_permission_rights() {
  ...
  "data": {
    ...
    #[test]
    fn it_check_effective_permission_right() {
  ...
  "data": {
    ...
    #[test]
    fn it_retrieve_device_identification_info() {
  ...
  "data": {
    ...
    #[test]
    fn it_list_notification_events() {
  ...
  "data": {
    ...
    "asset-migration-outcome": "Asset migration has been finalized"
        ...
        let result = ctn_client.list_notification_events().unwrap();
    ...
    fn it_send_request_success() {
        ...
        let result = ctn_client.send_request(req);
        ...
        assert_eq!(res.text().unwrap(), r#"{"status":"success","data":{"msgInfo":{"action":"send","from":{"deviceId":"d8YpQ7jgPBJEkBrnvp58","name":"TstDev2"}},"msgData":"Test message #1 (2020-11-30)"}}"#);
    }

    #[test]
    fn it_send_request_error() {
        // Simulate error 'Read Message' API method response
    ...
    #[test]
    fn it_sign_and_send_request_success() {
        // Simulate successful 'Read Message' API method response
        ...
        let result = ctn_client.sign_and_send_request(req);
    ...
    #[test]
    fn it_sign_and_send_request_error() {
        // Simulate error 'Read Message' API method response
    ...
    #[test]
    fn it_assemble_post_request_with_compression_not_done() {
        // Instantiate Catenis API client
        let ctn_client = CatenisClient::new_with_options(
            Some((
                "drc3XdxNtzoucpw9xiRp",
    ...
    #[test]
    fn it_assemble_post_request_with_compression() {
        // Instantiate Catenis API client
        let ctn_client = CatenisClient::new_with_options(
            Some((
                "drc3XdxNtzoucpw9xiRp",
    ...
    fn it_parse_response() {
        ...
        let res = reqwest::blocking::get(&format!("http://localhost:{}/messages/oNXszDazhuq4utktSMMi", server_port)).unwrap();

        // Parse response
        let result: Result<ReadMessageResponse> = CatenisClient::parse_response(res);
    ...
    #[test]
    fn it_get_new_http_client_with_no_compression() {
        ...
        let res = http_client.execute(req).unwrap();
    ...
    #[test]
    fn it_get_new_http_client_with_compression() {
        // Start HTTP server in echo mode to retrieve HTTP request effectively sent
        let http_server = HttpServer::new(HttpServerMode::Echo, "localhost");
        http_server.start();
    ...
    #[test]
    fn it_automatically_decompress_response() {
